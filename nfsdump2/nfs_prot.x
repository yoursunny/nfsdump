...
/*
 * [DJE 3/23/2007] This copy of nfs_prot.x was taken from the source
 * of FreeBSD 6.2-PRERELEASE.  It was edited to comment out the
 * __FBSDID macro, which does not compile correctly on other
 * platforms.
 */
